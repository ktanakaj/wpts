...
【ファイル】 wptscs140.msi, wptscs140.zip
【作成月日】 2026/05/07
【制 作 者】 Honeplus
...
・インストール方法
インストーラ版の場合は画面の指示に従いインストールを進めてください。
zip版の場合は、適当なフォルダに展開してください。
...
・アンインストール方法
インストーラ版の場合はコントロールパネルからのアンインストールを、
zip版の場合は展開したファイルを削除してください。
また、必要なら上記設定ファイルも削除してください。
...
Ver1.20  2012/03/10 Wiktionary/Wikitravelでの動作に対応。
                    設定の切り替え／追加機能を追加。
...
Ver1.21  2012/12/09 記事名が空の不正なテンプレート呼び出しで処理が落ちていたのを修正。
                    記事名の末尾がハテナマークの場合に警告を出すよう修正。
